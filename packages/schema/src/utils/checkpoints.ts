...
export function createCheckpointState(cpId: string, x: number, y: number): CheckpointState {
...
export function markCheckpointCollected(cp: CheckpointState, sessionId: string): void {
  cp.collected = true;
